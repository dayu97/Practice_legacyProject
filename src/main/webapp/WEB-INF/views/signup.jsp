		...
		$("#mid").blur(function() { 
			if($('#mid').val()==''){ 
				...
				if(data.cnt > 0){ 
					...
					if(idJ.test(mid)){ $('#id_check').text('사용가능한 아이디 입니다.'); 
	...
	function execPostCode() { 
		new daum.Postcode({ 
			oncomplete: function(data) { 
				...
				console.log(data.zonecode); console.log(fullRoadAddr); 
		...
		<div class="col-sm-6 col-md-offset-3"> 
			<form action="memberjoin" method="post" role="form" id="usercheck" name="member">
				...
				<!--<div class="form-group">
					...
					<input type="tel" class="form-control" id="mbirth" name="mbirth" placeholder="ex) 19990101">
					<div class="eheck_font" id="birth_check"></div>
				</div>
				 <div class="form-group">
					<label for="mem_email">이메일 주소</label> 
					<input type="email" class="form-control" id="memail" name="memail" placeholder="E-mail">
					<div class="eheck_font" id="email_check"></div>
				</div>
				<div class="form-group">
					<label for="mem_gender">성별 </label> 
					<input type="radio" id="mgender" name="mgender" value="남">남 
					<input type="radio" id="mgender" name="mgender" value="여">여
				</div> -->
				<div class="form-group">
					<label for="mphone">휴대폰 번호('-'없이 번호만 입력해주세요)</label> 
					<input type="tel" class="form-control" id="mphone" name="mphone" placeholder="Phone Number">
					<div class="eheck_font" id="phone_check"></div>
				</div>

				<div class="form-group">
					<input class="form-control" style="width: 40%; display: inline;" placeholder="우편번호" name="moaddress" id="moaddress" type="text" readonly="readonly">
					<button type="button" class="btn btn-default" onclick="execPostCode();">
						<i class="fa fa-search"></i> 우편번호 찾기
					</button>
				</div>
				<div class="form-group">
					<input class="form-control" style="top: 5px;" placeholder="도로명 주소" name="maddress" id="maddress" type="text" readonly="readonly" />
				</div>
				<div class="form-group">
					<input class="form-control" placeholder="상세주소" name="mdetailaddress" id="mdetailaddress" type="text" />
				</div>
